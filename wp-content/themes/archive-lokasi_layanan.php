	...
	<div class="location-grid">
		<?php if ( have_posts() ) : ?>
			<?php while ( have_posts() ) : the_post(); ?>
				...
				?>
				<article <?php post_class( 'location-card' ); ?>>
					...
					<div class="location-card__body">
						...
						<div class="location-meta">
							<?php if ( $jam_operasional ) : ?>
								<span><strong><?php esc_html_e( 'Jam', 'satlantas-ponorogo' ); ?></strong><?php echo esc_html( $jam_operasional ); ?></span>
							<?php endif; ?>
