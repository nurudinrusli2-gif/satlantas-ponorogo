...
<main id="primary" class="site-main front-page">
	...
	<section class="section services-section" aria-labelledby="services-title">
		...
		<div class="service-grid main-service-grid">
			<?php
			$services = array(
				array( 'SIM', 'Pembuatan SIM Baru & Perpanjangan SIM', 'sim' ),
				array( 'STNK & BPKB', 'Pengesahan STNK Tahunan', 'paper' ),
				array( 'Tilang & ETLE', 'Pengecekan Tilang Elektronik', 'plate' ),
				array( 'Pengaduan', 'Sampaikan Keluhan Anda', 'phone' ),
				array( 'Info & Layanan', 'Informasi Lalu Lintas & Layanan Lainnya', 'info' ),
			);
